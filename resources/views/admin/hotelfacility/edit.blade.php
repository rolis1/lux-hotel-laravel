...
<style>
    /* Custom Hotel Facility Edit Styles */
    .card {
        border: none;
        border-radius: 15px;
    ...
    .form-group:focus-within .edit-highlight::after {
        opacity: 1;
    }
    ...
    /* Label enhancement with edit icon */
    label {
        display: flex;
        align-items: center;
        margin-bottom: 8px;
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('hotelfacility.update', $data->id) }}" method="post">
            @csrf
            @method('patch')
            <div class="form-group edit-highlight">
                <label for="facility_name">Facility Name</label>
                <input id="facility_name" value="{{ $data->facility_name }}" name="facility_name" type="text" class="form-control @error('facility_name') is-invalid @enderror" value="{{ old('facility_name') }}" required autocomplete="facility_name" autofocus placeholder="Enter updated facility name">
                ...
                @enderror
                <div class="help-text">Update the name of the hotel facility.</div>
            </div>
            
            <div class="form-group edit-highlight">
                <label for="detail">Description</label>
                <div class="textarea-wrapper">
                    <textarea name="detail" class="form-control @error('detail') is-invalid @enderror" id="detail" rows="4" required autocomplete="detail" autofocus placeholder="Update the facility description...">{{ old('detail', $data->detail) }}</textarea>
                    <div class="char-count" id="charCount">{{ strlen($data->detail) }}/500</div>
                </div>
                ...
                @enderror
                <div class="help-text">Update the detailed description of the facility.</div>
            </div>
