            ...
            @else
                    ...
                    <div class="transaction-card">
                        <div class="transaction-header">
                            <div>
                                ...
                                <div class="room-number">Room {{ $item->roomNumber->number }}</div>
                            </div>
                        ...
                        <div class="transaction-body">
                            <div class="transaction-details">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span class="detail-value">{{ $item->roomNumber->number }}</span>
                                </div>
                                <div class="detail-item">
                ...
                <div class="pay-all-section">
                    <div class="pay-all-info">
                        <span class="pay-all-label">Total Amount Due</span>
                        <span class="pay-all-amount">@currency($pay)</span>
                    </div>
                    <button type="button" class="btn btn-success-custom btn-custom" data-bs-toggle="modal" data-bs-target="#payAllType">
                        <i class="fas fa-credit-card"></i> Pay All Transactions
                    </button>
                </div>
                @endif
            @endif
